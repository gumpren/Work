...
;    The GAUSS2DFIT function fits a two-dimensional, elliptical Gaussian equation 
;    to rectilinearly gridded data. Given a set of gridded data, Z = F(x, y),
; :Categories:
;
;
;
