pro plot_line_mlt_bz_lasttime_less_panel

  start=systime(1)
  save_str=''
  title_char='line_mlt_bz_lasttime_less_panel'
  ...
  str_element,opt_plot,'yticks',2,/add
  ...
  mlt_=hash()
  mlt_[0,0]=mlt_mean[0:4]      &     mlt_[0,1]=mlt_median[0:4]
  mlt_[1,0]=mlt_mean[5:9]     &      mlt_[1,1]=mlt_median[5:9]
