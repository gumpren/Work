pro plot_line_maglat_bz_lasttime
  start=systime(1)
  save_str=''
  title_char='line_maglat_bz_lasttime'
  ...
  str_element,opt_plot,'yrange',[-90,90],/add
  str_element,opt_plot,'xtickformat','(a1)',/add
  title_arr=['northward_IMF','southward_IMF']
  maglat_=hash()
  maglat_[0,0]=maglat_mean[0:14]      &     maglat_[0,1]=maglat_median[0:14]
  maglat_[1,0]=maglat_mean[15:29]     &     maglat_[1,1]=maglat_median[15:29]
