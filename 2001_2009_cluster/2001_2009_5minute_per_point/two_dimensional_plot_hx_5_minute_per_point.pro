pro two_dimensional_plot_hx_5_minute_per_point
  ...
  title_char='two_dimensional_plot_hx_Bz_Le_0_5_minute_per_point_0_margin';
  ...
  pos=set_plot_position(5,6,left=0.01,right=0.73,xgap=0.02,ygap=0.02,low=0.01,high=0.95)
  ...
  bar_title=[bar_title5,bar_title5,bar_title5,bar_title5,bar_title5]
  zrange=[[zrange5],[zrange5],[zrange5],[zrange5],[zrange5]]

  for i=0,29 do begin
    event_n[i]=reform(event_n[i+30],10*30*reverse_gap^2)
    event_t[i]=reform(event_t[i+30],10*30*reverse_gap^2*factor_to_kev)
    event_p[i]=reform(event_p[i+30],10*30*reverse_gap^2)
    event_vx[i]=reform(event_vx[i+30],10*30*reverse_gap^2)
    event_hx[i]=reform(event_hx[i+30],10*30*reverse_gap^2)
    event_kx[i]=reform(event_kx[i+30],10*30*reverse_gap^2)
    event_h_k_x[i]=reform(event_h_k_x[i+30],10*30*reverse_gap^2)
  endfor

  data=[[[event_hx[0]],[event_hx[1]],[event_hx[2]],[event_hx[3]],[event_hx[4]],[event_hx[5]]],$
           [[event_hx[6]],[event_hx[7]],[event_hx[8]],[event_hx[9]],[event_hx[10]],[event_hx[11]]],$
           [[event_hx[12]],[event_hx[13]],[event_hx[14]],[event_hx[15]],[event_hx[16]],[event_hx[17]]],$
           [[event_hx[18]],[event_hx[19]],[event_hx[20]],[event_hx[21]],[event_hx[22]],[event_hx[23]]],$
           [[event_hx[24]],[event_hx[25]],[event_hx[26]],[event_hx[27]],[event_hx[28]],[event_hx[29]]]]
