 pro cluster_energy_flux_density_statistics_data_6
    Re=6371.0
...
;  t_e=t_end
;  
;  b=findgen(32)      ;add new array of time range [0,5]
;  t_beg=list(b,/ex)
;  t_end=list(b,/ex)
;  
...
;    
;    t_beg[0]=t_beg[1]
;    t_end[0]=t_beg[1]+5*60.
;    
;    t_beg[16]=t_beg[17]
;    t_end[16]=t_beg[17]+5*60
;   
;  save,t_beg,t_end,$
...
;  
;  
;        filename2=file_search('C:\__Data\Cluster\CIS\CSA_Download_2
;        
;      0161216_0640\C3_CP_CIS-HIA_ONBOARD_MOMENTS\*__'+year+'*.cdf')
