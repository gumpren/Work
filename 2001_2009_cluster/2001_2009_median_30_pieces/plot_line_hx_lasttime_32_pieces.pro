pro plot_line_hx_lasttime_32_pieces
  ...
  title_char='line_hx_ey_gt_0_lasttime_halfhour_per_point';
...
;        '[5.5,6.0]','[6.0,6.5]','[6.5,7.0]','[7.0,7.5]','[7.5, 8.0]'],/add
      ...
      cgplot,x,get_Data[*,0,i],position=pos[i,0,*],xrange=[0.5,16.5],yrange=[0,0.8],_extra=opt_plot,/normal,/noerase
