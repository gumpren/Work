pro cluster_EFD_statistics_plot_all
  ...
  restore,root_dir+'event_data_2001_2009_gap1.000Re_list_all_plus_median.sav'
  ...
  bar_title7='H_K!dX!N!X (10!u16!n!xergs!u-1!n!xRe!u2!n!x)'
  ...
  zrange4=[-40,40];V
  zrange5=[-0.4,0.4];H
  zrange61=[-0.03,0.03];K1 _mean
  zrange62=[-0.0004,0.0004];K2  _median 
  zrange7=[-0.45,0.45];H_K
...
;        [[event_hx[0]],[event_hx[1]],[event_hx[2]],[event_hx[3]],[event_hx[4]],[event_hx[5]]]]
  data=[[[event_h_k_x[0]],[event_h_k_x[1]],[event_h_k_x[2]]],   $
        [[event_h_k_x[3]],[event_h_k_x[4]],[event_h_k_x[5]]]]
;  data=[[[event_kx[0]],[event_kx[1]],[event_kx[2]]],   $
;        [[event_kx[3]],[event_kx[4]],[event_kx[5]]]]
;  data=[[[event_hx[0]],[event_hx[1]],[event_hx[2]]],   $
;        [[event_hx[3]],[event_hx[4]],[event_hx[5]]]]
  
  bar_title=[bar_title7,bar_title7]
  zrange=[[zrange7],[zrange7]]
  
  title_char='H_K_X_all_median'
  ...
  pos=set_plot_position(2,3,left=0.01,right=0.7,xgap=0.03,ygap=0.03,low=0.01,high=0.96)
  ;cgloadct,38;,/reverse
  ;cgloadct,72,/reverse
...
;________________________________plot_energy_flux_density_______________________
  ...
  data1=[[[H_Re_x1],[H_Re_x2],[H_Re_x3]],$
         [[H_Re_x4],[H_Re_x5],[H_Re_x6]]]
  data2=[[[H_Re_y1],[H_Re_y2],[H_Re_y3]],$
...
;  ;v      change : title,not change; image, change
  ...
  idx=where(data eq 0)
  data[idx]=!values.f_nan
  pos=set_plot_position(2,3,left=0.01,right=0.64,xgap=0.04,ygap=0.04,low=0.01,high=0.95)
  ;cgloadct,38;,/reverse
  ;cgloadct,72,/reverse
  restore,'E:\OneDrive\IDLworks\Other\blue_white_red_256.ctl'
