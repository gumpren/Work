 pro cluster_energy_flux_density_statistics_data_4
    Re=6371.0
...
;            end
;          1:begin
;             find_conti_intervals,'BZ_GSM',0,1000,margin=2*60,duration=[15*60.,45*60.],nint=nint,tbeg=tbeg0,tend=tend0
;             append_array,tbeg2,tbeg0
;             append_array,tend2,tend0
;            end
;          2:begin
;             find_conti_intervals,'BZ_GSM',0,1000,margin=2*60,duration=[45*60.,90*60.],nint=nint,tbeg=tbeg0,tend=tend0
...
;            end
;          5:begin
;             find_conti_intervals,'BZ_GSM',-1000,0,margin=2*60,duration=[15*60.,45*60.],nint=nint,tbeg=tbeg0,tend=tend0
;             append_array,tbeg6,tbeg0
;             append_array,tend6,tend0
;            end
;          6:begin
;             find_conti_intervals,'BZ_GSM',-1000,0,margin=2*60,duration=[45*60.,90*60.],nint=nint,tbeg=tbeg0,tend=tend0
...
;  endfor
;
;  t_beg=create_struct('tbeg1',tbeg1,'tbeg2',tbeg2,'tbeg3',tbeg3,'tbeg4',tbeg4,'tbeg5',tbeg5,'tbeg6',tbeg6,'tbeg7',tbeg7,'tbeg8',tbeg8)
;  t_end=create_struct('tend1',tend1,'tend2',tend2,'tend3',tend3,'tend4',tend4,'tend5',tend5,'tend6',tend6,'tend7',tend7,'tend8',tend8)
;  
;  save,t_beg,t_end,$
;    filename='C:\__Data\Datasave\2001_2009_median_new_4\time_interval_divided_by_Bz.sav'
;  
;  stop
  ;________________________________part2_______________________
  
  ;________________________________part2_______________________
    restore,'C:\__Data\Datasave\2001_2009_median_new_4\time_interval_divided_by_Bz.sav'
    start=systime(1)
    for kk=4,7 do begin 
      case kk  of
        0:begin
      ...
      endcase
    names=['_BZgt0_5_15','_BZgt0_15_45','_BZgt0_45_90','_BZgt0_gt_90',$
           '_BZle0_5_15','_BZle0_15_45','_BZle0_45_90','_BZle0_gt_90']
...
;    save_time_c3fgmcis=strcompress(save_time_c3fgmcis,/remove)+' hours'
    ...
    save,save_time_c3fgmcis,t_c3fgm1,t_c3cis1,B_total1,B_gsm1,pos_gsm1,density1,velocity_gsm1,temperature1,pressure1,$
      filename='C:\__Data\Datasave\2001_2009_median_new_4\c3_fgmcis_data_selected_'+names[kk]+'.sav'
