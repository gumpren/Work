pro plot_massflux_xy_new
  ...
  cgps_open,output_dir+'massflux_xy'+save_str+'.ps',xsize=6.0,ysize=7.0
  event_mfx1=reform(event_vx1*event_n1,10*30*reverse_gap^2)
  event_mfx2=reform(event_vx2*event_n2,10*30*reverse_gap^2)
  event_mfx3=reform(event_vx3*event_n3,10*30*reverse_gap^2)
  event_mfx4=reform(event_vx4*event_n4,10*30*reverse_gap^2)
  event_mfy1=reform(event_vy1*event_n1,10*30*reverse_gap^2)
  event_mfy2=reform(event_vy2*event_n2,10*30*reverse_gap^2)
  event_mfy3=reform(event_vy3*event_n3,10*30*reverse_gap^2)
  event_mfy4=reform(event_vy4*event_n4,10*30*reverse_gap^2)
