pro plot_line_hx_lasttime_44_pieces
  ...
  title_char='line_hx_lasttime_44_pieces_5_30_near';
  ...
  restore,filepath('event_data'+save_str+'_list_44_pieces_event_5_30_near.sav',root_dir=root_dir)

  x=indgen(22)+1

  median_hx1=dblarr(22)
  average_hx1=dblarr(22)
  median_hx2=dblarr(22)
  average_hx2=dblarr(22)

  err_median_hx1=dblarr(22)
  err_average_hx1=dblarr(22)
  err_median_hx2=dblarr(22)
  err_average_hx2=dblarr(22)
  ;  STDDEV()
  ...
  for i=0,21 do begin
    ...
    median_hx2[i]=median((H_Re[i+22])[*,0])
    average_hx2[i]=average((H_Re[i+22])[*,0],/nan)
