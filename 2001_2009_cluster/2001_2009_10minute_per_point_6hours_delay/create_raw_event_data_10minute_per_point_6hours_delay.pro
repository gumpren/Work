...
pro create_raw_event_data_10minute_per_point_6hours_delay
  
   Re=6371.0
   root_dir='C:\__Data\Datasave\2001_2009_10minute_per_point_6hours_delay\'
   start=systime(1)
   compile_opt idl2    
...
;   endfor
;   save,t_beg,t_end,  $
;     filename=root_dir+'time_interval_divided_by_Bz_yearly_normal_10minute_per_point_6hours_delay.sav'
;
;   
...
;       
;                  
;     restore,root_dir+'time_interval_divided_by_Bz_yearly_normal_10minute_per_point_6hours_delay.sav'
;    
;     names=strarr(30)
...
;           filename=root_dir+'c3_fgmcisefw_data_selected_10minute_per_point_6hours_delay'+names[kk]+'.sav'
;    
...
; ; ________________________________part3_______________________
    ...
    filename=file_search(root_dir+'c3_fgmcisefw_data_selected_10minute_per_point_6hours_delay'+'*.sav')
...
;      event_hx,event_kx,event_h_k_x,event_hy,event_ky,event_h_k_y,filename=root_dir+'full_event_data'+save_str+'_list_10minute_per_point.sav'
    ...
    save,t_c3cis,t_last,density,temperature,pressure,velocity_gsm,B_gsm,pos_gsm,E_gsm_y,H_Re,K_Re,H_K_Re,    $
      filename=root_dir+'full_raw_data'+save_str+'_list_10minute_per_point_6hours_delay'+region_str+'.sav'
 ;   stop
