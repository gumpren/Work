pro plot_line_hx_lasttime_10minute_per_point_6hours_delay
  
  namestr='full_'
  suffix_str='_near_duskflank'
  ...
  filename=root_dir+namestr+'raw_data'+save_str+'_list_10minute_per_point_6hours_delay'+suffix_str+'.sav'
  
  output_dir='E:\OneDrive\IDLworks\PS\cluster_statistics\2001_2009_10minute_per_point_6hours_delay\'
  title_char='line_hx_lasttime_10minute_per_point_6hours_delay'+suffix_str
