pro plot_velocity_vector_10minute_per_point
  ...
  title_char='velocity_vector_IMFBZ_north_10minute_per_point';
  panel_title='B!dz!n!x>0'
  bbindex=0

  restore,filename=root_dir+'event_data'+save_str+'_list_10minute_per_point_add_time_after_150_minutes.sav'
