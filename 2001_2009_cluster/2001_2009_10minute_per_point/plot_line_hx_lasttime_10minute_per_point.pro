pro plot_line_hx_lasttime_10minute_per_point
  ...
  title_char='line_hx_lasttime_10minute_per_point_add_time_after_150_minutes_near_dawnflank_full';

  title0=['median_hx_Bz','average_hx_Bz']
  ytitle='H'+cgsymbol('sub')+'x'       
  
  restore,filename=root_dir+'raw_data'+save_str+'_list_10minute_per_point_add_time_after_150_minutes_near_dawnflank_full.sav'
  x=indgen(15)
