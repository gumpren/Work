...
pro scatter_plot_2d_variable_lasttime_10minute_per_point_4panel
  ...
  title_char=namestr+'22_plot_2d_median_'+vari_str+'_dawn_dusk_lasttime_10minute_per_point_4panel'
...
;  cgtext,0.98,0.60,'median',alignment=0,charsize=1.0,font=0,color='red',/normal
;  cgtext,0.98,0.58,'average',alignment=0,charsize=1.0,font=0,color='royal blue',/normal 
