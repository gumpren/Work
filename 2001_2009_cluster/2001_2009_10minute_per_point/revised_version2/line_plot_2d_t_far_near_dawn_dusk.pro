...
pro line_plot_2d_t_far_near_dawn_dusk
  ...
  for j=0,3 do begin
    ...
    if j eq 0  or j eq 2 or j eq 3 then begin
      str_element,opt_plot,'ytitle','T (keV)',/delete
    endif
