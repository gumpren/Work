...
pro line_plot_2d_n_far_near_dawn_dusk
...
;             ['S-IMF Dawnflank','S-IMF Duskflank']]
 ...
 ; str_element,opt_plot,'ytickname',ytickname,/add
  ...
  str_element,opt_plot,'ytitle','N ('+'cm'+cgsymbol('up')+'-3'+'!n)',/add
...
;      endelse
     for j=0,3 do begin
      ...
      if j eq 0  or j eq 2 or j eq 3 then begin
        str_element,opt_plot,'ytitle','N ('+'cm'+cgsymbol('up')+'-3'+'!n)',/delete
      endif
