...
pro line_plot_2d_vx_test_dawnflank
...
;  typee=2; dusk
  ...
  title_char=namestr+'vx'+region_s+'_remove_duplicate_points_line_plot_2d'
 ...
 ; cgps_open,output_dir+title_char+save_str+'.ps',xsize=6.0,ysize=7.0
  ...
  cgLegend, Colors=['black', 'black'], linestyle=[0,2],alignment=1,charsize=0.8, Symsize=0.4, Location=[0.48, 0.41], $
