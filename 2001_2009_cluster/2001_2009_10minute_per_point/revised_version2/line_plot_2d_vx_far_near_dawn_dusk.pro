...
pro line_plot_2d_vx_far_near_dawn_dusk
  ...
  str_element,opt_plot,'yrange',[1.0,100.0],/add
  ;
  ...
  for j=0,3 do begin
    ...
    if j eq 0  or j eq 2 or j eq 3 then begin
      str_element,opt_plot,'ytitle','V'+cgsymbol('down')+'x'+'!n  (km/s)',/delete
    endif
