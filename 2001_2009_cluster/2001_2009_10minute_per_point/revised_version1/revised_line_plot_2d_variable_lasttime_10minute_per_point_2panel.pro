...
pro revised_line_plot_2d_variable_lasttime_10minute_per_point_2panel
  ...
  vari_dusk=H_re
  vari_str='H!dx!n' ;H!dx!n
  tt_dusk=t_last
  
  title_char=namestr+'nolog_revised_smooth_2panel_plot_2d_median_'+vari_str+'_dawn_dusk_lasttime_10minute_per_point'
...
;             ['S-IMF Dawnflank','S-IMF Duskflank']]
 ...
 ; str_element,opt_plot,'xtitle','Time(minutes)',/add                                                     
  ...
  str_element,opt_plot,'yrange',[0.01,0.2],/add
  ;
  for i=0,1 do begin
