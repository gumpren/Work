...
pro line_plot_2d_kx_dawnflank
  ...
  title_char=namestr+'line_plot_2d_kx'+region_strs[1]+'_remove_duplicate_points'
...
;             ['S-IMF Dawnflank','S-IMF Duskflank']]
 ...
 ; str_element,opt_plot,'ytickname',ytickname,/add
  ...
  str_element,opt_plot,'ytitle','K'+cgsymbol('down')+'x'+'!n (10!u16!n!xergs!u-1!n!xRe!u2!n!x)',/add
  ...
  str_element,opt_plot,'yrange',[1.0e-5,1.0e-3],/add
  ;
;  for i=0,1 do begin      
