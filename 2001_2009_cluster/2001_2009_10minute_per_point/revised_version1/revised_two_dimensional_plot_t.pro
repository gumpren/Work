pro revised_two_dimensional_plot_t
  ...
  title_char='revised_two_dimensional_plot_t_Bz_southward'
  ...
  zrange1=[0.05,0.5];zrange1=[0.05,0.5];N
  zrange2=[0.10,7.0];T
  zrange3=[0.01,0.2];P
  zrange4=[-50,50];V
  zrange5=[-0.4,0.4];H
  zrange6=[-0.001,0.001];K
  zrange7=[1,4000]  ;Number
 
  bar_title=[bar_title2,bar_title2,bar_title2]
  zrange=[[zrange2],[zrange2],[zrange2]]
  ...
  data=[[[event_t[0]],[event_t[1]],[event_t[2]],[event_t[3]],[event_t[4]]],$
        [[event_t[5]],[event_t[6]],[event_t[7]],[event_t[8]],[event_t[9]]],$
        [[event_t[10]],[event_t[11]],[event_t[12]],[event_t[13]],[event_t[14]]]]
 ...
 ; str_element,opt_bar,'DIVISIONS',1,/add
  ...
  for i=0,2 do begin
    ...
    for j=0,4 do begin
      ...
      color_fill,pos[i,j,*],d,xrange=xrange,yrange=yrange,zrange=zrange[*,i],top=254,bottom=20,backcolor='grey',zlog=1,opt_plot=opt_plot,opt_bar=opt_bar   ;
