...
pro line_plot_2d_n_t_dawnflank_median_first
  ...
  vari_dawn=list(length=30)
  vari_dusk=list(length=30)
  
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_10minute_per_point'+region_strs[1]+'.sav'
  vari1_dawn=density
  vari2_dawn=temperature
  tt_dawn=t_last
  
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_10minute_per_point'+region_strs[2]+'.sav'
  vari1_dusk=density
  vari2_dusk=temperature 
  tt_dusk=t_last
  
  title_char=namestr+'line_plot_2d_n_t_dawnflank_median_first'

  x=10*(indgen(15))+5
  
  median_vari1_dawn_north=dblarr(15)
  median_vari1_dawn_south=dblarr(15)
  median_vari1_dusk_north=dblarr(15)
  median_vari1_dusk_south=dblarr(15)
  
  median_vari2_dawn_north=dblarr(15)
  median_vari2_dawn_south=dblarr(15)
  median_vari2_dusk_north=dblarr(15)
  median_vari2_dusk_south=dblarr(15)
...
;  average_vari_dusk_south=dblarr(15)
 ...
 ; restore,filename='C:\__Data\Datasave\2001_2009_10minute_per_point\earthward_flow_index.sav'
  ...
  for i=0,14 do begin
    ...
    if ( (size(vari1_dusk[i]))[0] eq 1)  then begin
      vari1_dawn_north=get_varii(vari1_dawn[i],log=0)
      vari1_dawn_south=get_varii(vari1_dawn[i+15],log=0)
      vari1_dusk_north=get_varii(vari1_dusk[i],log=0)
      vari1_dusk_south=get_varii(vari1_dusk[i+15],log=0) 
      
      vari2_dawn_north=get_varii(vari2_dawn[i],log=0)
      vari2_dawn_south=get_varii(vari2_dawn[i+15],log=0)
      vari2_dusk_north=get_varii(vari2_dusk[i],log=0)
      vari2_dusk_south=get_varii(vari2_dusk[i+15],log=0)     
    endif
    
    if ( (size(vari1_dusk[i]))[0] eq 2)  then begin
      vari1_dawn_north=get_varii((vari1_dawn[i])[*,0],log=0)
      vari1_dawn_south=get_varii((vari1_dawn[i+15])[*,0],log=0)
      vari1_dusk_north=get_varii((vari1_dusk[i])[*,0],log=0)
      vari1_dusk_south=get_varii((vari1_dusk[i+15])[*,0],log=0)
      
      vari2_dawn_north=get_varii((vari2_dawn[i])[*,0],log=0)
      vari2_dawn_south=get_varii((vari2_dawn[i+15])[*,0],log=0)
      vari2_dusk_north=get_varii((vari2_dusk[i])[*,0],log=0)
      vari2_dusk_south=get_varii((vari2_dusk[i+15])[*,0],log=0)
    endif
       
       
    median_vari1_dawn_north[i]=median(vari1_dawn_north)
    median_vari1_dawn_south[i]=median(vari1_dawn_south)
    median_vari1_dusk_north[i]=median(vari1_dusk_north)   
    median_vari1_dusk_south[i]=median(vari1_dusk_south)
    
    median_vari2_dawn_north[i]=median(vari2_dawn_north)
    median_vari2_dawn_south[i]=median(vari2_dawn_south)
    median_vari2_dusk_north[i]=median(vari2_dusk_north)
    median_vari2_dusk_south[i]=median(vari2_dusk_south)
...
;    average_vari_dusk_south[i]=average(vari_dusk_south,/nan)
    ...
    append_Array,vari1_dawn_north1,vari1_dawn_north
    append_Array,vari1_dawn_south1,vari1_dawn_south
    append_Array,vari1_dusk_north1,vari1_dusk_north
    append_Array,vari1_dusk_south1,vari1_dusk_south
    
    append_Array,vari2_dawn_north1,vari2_dawn_north
    append_Array,vari2_dawn_south1,vari2_dawn_south
    append_Array,vari2_dusk_north1,vari2_dusk_north
    append_Array,vari2_dusk_south1,vari2_dusk_south
  ...
  vari1_arr=hash()
  vari1_arr[0,0]=vari1_dawn_north1   &    vari1_arr[0,1]=vari1_dawn_south1
  vari1_arr[1,0]=vari1_dusk_north1   &    vari1_arr[1,1]=vari1_dusk_south1
  
  vari2_arr=hash()
  vari2_arr[0,0]=vari2_dawn_north1   &    vari2_arr[0,1]=vari2_dawn_south1
  vari2_arr[1,0]=vari2_dusk_north1   &    vari2_arr[1,1]=vari2_dusk_south1
 ; if ((vari_str eq 'H!dx!n' or vari_str eq 'K!dx!n')eq 1b)  then median_vari_dusk_south[11]=!values.f_nan
  
  median_arr=hash()
  median_arr[0,0]=median_vari1_dawn_north*median_vari2_dawn_north
  median_arr[0,1]=median_vari1_dawn_south*median_vari2_dawn_south
  median_arr[1,0]=median_vari1_dusk_north*median_vari2_dusk_north
  median_arr[1,1]=median_vari1_dusk_south*median_vari2_dusk_south
...
;             ['S-IMF Dawnflank','S-IMF Duskflank']]
  title_arr=['Dawnflank N*T'];,'Duskflank'
 ...
 ; str_element,opt_plot,'ytickname',ytickname,/add
  str_element,opt_plot,'ytitle',vari_str,/add
  ...
  str_element,opt_plot,'yrange',[0.1,0.8],/add
