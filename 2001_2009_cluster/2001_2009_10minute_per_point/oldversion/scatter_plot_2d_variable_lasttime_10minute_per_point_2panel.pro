...
pro scatter_plot_2d_variable_lasttime_10minute_per_point_2panel
  ...
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_10minute_per_point'+region_str[1]+'.sav'
  vari=density
  vari_str='density'
  
  
  title_char=namestr+'scatter_plot_2d_median_'+vari_str+'_lasttime_10minute_per_point'+region_str
  x=10*(indgen(15))+5  
