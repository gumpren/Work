...
;     stop
     ...
     ;part2.2
     restore,root_dir+'time_interval_divided_by_Bz_yearly_normal_10minute_per_point_add_former_time.sav'
     ...
     for kk=29,0,-1 do begin     ;
       ...
       if is_array(t_c3cis1) then begin
         save,t_c3cis1,t_last1,B_total1,B_gsm1,pos_gsm1,density1,velocity_gsm1,temperature1,pressure1,Beta1,E_gsm1,$;$
           filename=root_dir+'c3_fgmcisefw_data_selected_10minute_per_point'+names[kk]+'.sav'
...
; ; ________________________________part3_______________________
    ...
    filename=file_search(root_dir+'c3_fgmcisefw_data_selected_10minute_per_point'+'*.sav')
