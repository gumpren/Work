...
pro line_plot_2d_variable_lasttime_halfhour_per_point_2panel
  ...
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_halfhour_per_point'+region_strs[1]+'.sav'
  vari_dawn=K_re 
  tt_dawn=t_last
  
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_halfhour_per_point'+region_strs[2]+'.sav'
  vari_dusk=K_re
  vari_str='K!dx!n'
  tt_dusk=t_last
  
  title_char=namestr+'smooth_2panel_plot_2d_median_'+vari_str+'_dawn_dusk_lasttime_halfhour_per_point'
  ...
  restore,filename='C:\__Data\Datasave\2001_2009_halfhour_per_point\earthward_flow_index.sav'
...
;             ['S-IMF Dawnflank','S-IMF Duskflank']]
  ...
  restore,'smooth hx hash arr.sav'
  median_arr=median_smooth_arr
