...
pro scatter_plot_2d_variable_lasttime_halfhour_per_point
  ...
  restore,filename=root_dir+namestr+'raw_data'+save_str+'_list_halfhour_per_point_add_time_after_8hours'+region_str+'.sav'
  vari=density
  vari_str='density'
  
  title_char=namestr+'scatter_plot_2d_'+vari_str+'_lasttime_halfhour_per_point'+region_str
