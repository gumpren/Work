pro plot_line_vx_lasttime_32_pieces
  ...
  title_char='line_vx_lasttime_32_pieces';

  ee=1
  tt=300

  title0=['median_vx_Bz','average_vx_Bz']
  ytitle='V'+cgsymbol('sub')+'x'
  ...
  median_vx1=dblarr(16)
  average_vx1=dblarr(16)
  median_vx2=dblarr(16)
  average_vx2=dblarr(16)

  err_median_vx1=dblarr(16)
  err_average_vx1=dblarr(16)
  err_median_vx2=dblarr(16)
  err_average_vx2=dblarr(16)
  ;  STDDEV()

  for i=0,15 do begin
    median_vx1[i]=median((velocity_gsm[i])[*,0])
    average_vx1[i]=average((velocity_gsm[i])[*,0],/nan)

    median_vx2[i]=median((velocity_gsm[i+16])[*,0])
    average_vx2[i]=average((velocity_gsm[i+16])[*,0],/nan)
  ...
  get_Data=[[[median_vx1],[median_vx2]],  $
            [[average_vx1],[average_vx2]]]
  ...
  for i=0,1 do begin
    ...
    cgplot,x,get_Data[*,0,i],position=pos[i,0,*],xrange=[0.5,16.5],yrange=[-50,50],_extra=opt_plot,/normal,/noerase
