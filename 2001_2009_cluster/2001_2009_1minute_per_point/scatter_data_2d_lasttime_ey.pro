...
;      ;;    index_all=where(pos_gsm1[index_all1,0] le -15.0 )
    ...
    save,t_last,eventimes,event_n,event_t,event_p,event_vx,event_vy,H_Re,K_Re,H_K_Re,event_ey,     $
      event_hx,event_kx,event_h_k_x,event_hy,event_ky,event_h_k_y,filename=root_dir+'scatter_event_data_ey_gt_0'+save_str+'_list_1minute_per_point_full.sav'
    
    save,t_c3cis,density,temperature,pressure,velocity_gsm,B_gsm,pos_gsm,E_gsm_y,    $
      filename=root_dir+'scatter_raw_data_ey_gt_0'+save_str+'_list_1minute_per_point_full.sav'
    stop
