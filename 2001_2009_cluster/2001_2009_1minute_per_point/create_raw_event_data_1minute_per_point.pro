;cerated by G.M. Ren   2017.12.29


pro create_raw_event_data_1minute_per_point
...
;      save,t_beg,t_end,$
;      filename=root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point.sav'
;    endfor
;    
    
;    ;part 1.2 add time after 145 minutes
...
;      endelse
;
;      duration=[145,6666666666]*60.   ;duration
;
;      marg=2*60.0  ;marg
;
...
;      print,jj
;    endfor
;    save,tt_beg,tt_end,filename=root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point_tt.sav'
;    stop
;  
  
;    ;part_1.3
;
;    restore,root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point_tt.sav'
;    restore,root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point.sav'
;    
;    t_beg139=t_beg[139]
;    t_end139=t_end[139]
;    append_array,t_beg139,tt_beg[0]
;    append_array,t_end139,tt_beg[0]+145.0*60
;    t_beg[139]=t_beg139
;    t_end[139]=t_end139
;
;    t_beg279=t_beg[279]
;    t_end279=t_end[279]
;    append_array,t_beg279,tt_beg[1]
;    append_array,t_end279,tt_beg[1]+145.0*60
;    t_beg[279]=t_beg279
;    t_end[279]=t_end279            ;add time after 150 minutes
;
;    aa=fltarr(280)
...
;  
;    save,t_beg,t_end,$
;          filename=root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point_add_former_time.sav'
;  
;    stop
;  
...
;       ;part2.2
;       restore,root_dir+'time_interval_divided_by_Bz_yearly_normal_1minute_per_point_add_former_time.sav'
;  
;       names=strarr(280)
...
;         endif else begin
;           bz='_BZle0_'
;           te=strcompress(kk+6-140,/remove)
;         endelse
;  
...
;  
;         if kk ge 140 and kk lt 140+5 then tb='00'+strcompress(kk+5-140,/remove)
;         if kk ge 140+5 and kk lt 140+95 then tb='0'+strcompress(kk+5-140,/remove)
;         if kk ge 140+95 and kk le 140+139 then tb=strcompress(kk+5-140,/remove)
;  
;         names[kk]=bz+tb+'_'+te
;       endfor
;  
;  
;       for kk=279,0,-1 do begin     ;
;         tbeg=t_beg[kk]
;         tend=t_end[kk]
;  
...
;             filename=root_dir+'c3_fgmcisefw_data_selected_1minute_per_point'+names[kk]+'.sav'
;  
...
;  ________________________________part3_______________________
    ...
    filename=file_search(root_dir+'c3_fgmcisefw_data_selected_1minute'+'*.sav')
    ...
    for jj=0,279 do begin
      if (jj ge 0) and (jj le 139)  then t_last_beg[jj]=(jj+5)
      if (jj ge 140) and (jj le 279)  then t_last_beg[jj]=(jj-135)
    endfor
...
;      event_hx,event_kx,event_h_k_x,event_hy,event_ky,event_h_k_y,filename=root_dir+'event_data'+save_str+'_list_1minute_per_point'+region_str+'.sav'
  
    save,t_c3cis,t_last,density,temperature,pressure,velocity_gsm,B_gsm,pos_gsm,E_gsm_y,H_Re,K_Re,H_K_Re,    $
      filename=root_dir+'raw_data'+save_str+'_list_1minute_per_point'+region_str+'.sav'
;    stop
