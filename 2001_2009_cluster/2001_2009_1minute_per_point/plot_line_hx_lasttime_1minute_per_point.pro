pro plot_line_hx_lasttime_1minute_per_point
  ...
  average_hx1=dblarr(140)
  median_hx2=dblarr(140)
  average_hx2=dblarr(140)
  ...
  for i=0,138 do begin
    ...
    median_hx2[i]=median((H_Re[i+139])[*,0])
    average_hx2[i]=average((H_Re[i+139])[*,0],/nan)
...
;    average_hx2[i]=average(event_hx[i+16])
    ...
    median_hx2[139]=median((H_Re[278])[*,0])
    average_hx2[139]=average((H_Re[278])[*,0],/nan)
    
    median_hx1[139]=median_hx1[138]
    average_hx1[139]=average_hx1[139]
