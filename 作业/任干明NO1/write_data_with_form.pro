...
Pro write_data_with_form
      ...
      openw,lun,filepath('peaceful_data.dat',root_dir='E:\IDLworks\浠诲共��O1'),/get_lun,width=500    
      ...
      openw,lun,filepath('active_data.dat',root_dir='E:\IDLworks\浠诲共��O1'),/get_lun,width=500
