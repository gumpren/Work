...
;
;  openw,lun,filepath('peaceful_data_noform.dat',root_dir='E:\IDLworks\任干明NO1'),/get_lun,width=500
;  writeu,lun,peaceful_data;,format='(i2,1x,i2,1x,i1,1x,i1,5x,i4,5x,i3)'
        ...
        openw,lun,filepath('active_data_noform.dat',root_dir='E:\IDLworks\任干明NO1'),/get_lun,width=500
