pro cluster_temperature_perp_par_data
   compile_opt idl2
...
;    cdf2tplot,filename2,varformat=['temp_par__C3_CP_CIS-HIA_ONBOARD_MOMENTS','temp_perp__C3_CP_CIS-HIA_ONBOARD_MOMENTS',$
...
;    
;    
;    transfer_fac=1.16e22  ;cal p(nPa)
...
;    get_Data,'B_gsm_interp',time_1,B_gsm
;    get_Data,'pressure_interp',time_1,pressure
;    
...
;  
;  save,save_time_c3fgmcis,time1,pos_gsm1,density1,temp_perp1,temp_par1,t_ratio1,Beta_par1,B_gsm1,pressure1,$
;    filename=root_dir+'c3_temperature_perp_par_data_2001_2009_wider_thiner_no_betalimit.sav'
;  stop
...
; ________________________________part3_______________________  
  ...
  restore,'C:\__Data\Datasave\dayside_plasma_sheet\c3_temperature_perp_par_data_2001_2009_wider_thiner_no_betalimit.sav'
  
  index1=where(temp_par1 le 30 and temp_par1 ge 0.005 and temp_perp1 le 30 and temp_perp1 ge 0.005)
  ...
  B_gsm1=B_gsm1[index1,*]
  pressure1=pressure1[index1,*]
...
;  bar_title2='!4'+String(98b)+'!X!D!9'+String(35b) +'!X!N'
  ...
  bar_title1='log(T!Dperp!n!x/T!Dpar!n!x)'
  bar_title2='Beta!Dpar!X'
  ...
  event_t_ratio=alog10(event_t_ratio)
  event_Beta_par=alog10(event_Beta_par)

  data=[[event_t_ratio],[event_Beta_par]]

  title_char='beta_par_wider_nobeta_limit'
