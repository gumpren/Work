 ...
 ; restore,filepath('C3_CIS_2001_2003_n_vbxyz_p_T_need_addbeta.sav',root_dir='C:\__Data\Datasave')
  restore,filepath('event_vxy_2001_2009_median.sav',root_dir='C:\__Data\Datasave')
...
;  ;���ܶ�     ��ά�ֲ�ͼ
  ...
  device,filename=output_dir+'velocity_vector_2001_2009_median.ps',xsize=5.5,ysize=6.5,xoffset=1,yoffset=2,/inches,/encapsulated
  !p.multi=[0,4,1,0,0]
  loadct,39
  device,decomposed=0
