pro plot_velocity_massflux_energyflux
  ...
  restore,filepath('event_n_2001_2009_median.sav',root_dir='C:\__Data\Datasave\2001_2009_median')
  restore,filepath('event_vxy_2001_2009_median.sav',root_dir='C:\__Data\Datasave\2001_2009_median')
  restore,filepath('Qk_Qt_2001_2009_median.sav',root_dir='C:\__Data\Datasave\2001_2009_median')
  restore,filepath('event_qk_2001_2009_median.sav',root_dir='C:\__Data\Datasave\2001_2009_median')
  restore,filepath('event_qt_2001_2009_median.sav',root_dir='C:\__Data\Datasave\2001_2009_median')
  ...
  ;  TVLCT, r, g, b,/Get
  ;  output_dir='E:\OneDrive\IDLworks\cluster_statistics\ps\2001_2009_median\'
  ...
  ;  set_plot,entry_device
    ...
    TVLCT, r, g, b,/Get
    output_dir='E:\OneDrive\IDLworks\cluster_statistics\ps\2001_2009_median\'
    device,filename=output_dir+'kinetic_energy_flux_2001_2009_median.ps',xsize=5.5,ysize=6.5,xoffset=1,yoffset=2,/inches,/encapsulated
    !p.multi=[0,4,1,0,0]
    loadct,39
    device,decomposed=0
    ...
    cgloadct,33,bottom=0,ncolors=ncolors
    scaled1=calculate_colors(event_qky1,bottom_flux,top_flux,Bottom,Ncolors)
    scaled2=calculate_colors(event_qky2,bottom_flux,top_flux,Bottom,Ncolors)
    scaled3=calculate_colors(event_qky3,bottom_flux,top_flux,Bottom,Ncolors)
    scaled4=calculate_colors(event_qky4,bottom_flux,top_flux,Bottom,Ncolors)
    scaled1[index1]=255
    scaled2[index2]=255
    scaled3[index3]=255
    scaled4[index4]=255
    ...
    cgloadct,33,bottom=0,ncolors=ncolors
    scaled1=calculate_colors(event_qkx1,bottom_flux,top_flux,Bottom,Ncolors)
    scaled2=calculate_colors(event_qkx2,bottom_flux,top_flux,Bottom,Ncolors)
    scaled3=calculate_colors(event_qkx3,bottom_flux,top_flux,Bottom,Ncolors)
    scaled4=calculate_colors(event_qkx4,bottom_flux,top_flux,Bottom,Ncolors)
    scaled1[index1]=255
    scaled2[index2]=255
    scaled3[index3]=255
    scaled4[index4]=255
...
;  cgloadct,33,bottom=0,ncolors=ncolors
;  scaled1=calculate_colors(event_qty1,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled2=calculate_colors(event_qty2,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled3=calculate_colors(event_qty3,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled4=calculate_colors(event_qty4,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled1[index1]=255
;  scaled2[index2]=255
;  scaled3[index3]=255
;  scaled4[index4]=255
...
;  cgloadct,33,bottom=0,ncolors=ncolors
;  scaled1=calculate_colors(event_qtx1,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled2=calculate_colors(event_qtx2,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled3=calculate_colors(event_qtx3,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled4=calculate_colors(event_qtx4,bottom_flux,top_flux,Bottom,Ncolors)
;  scaled1[index1]=255
;  scaled2[index2]=255
;  scaled3[index3]=255
;  scaled4[index4]=255
