pro ren_statistic_analysis
  ...
  condition0=[-100,0]
  condition1=[0,9000]
  cdf_file=file_search('D:\__Data\test\c3\*.cdf')
  ...
  for ii=0,nopoints-1 do begin
    CDF_EPOCH,epoch[ii],yr,mo,dy,hr,min,sec,milli,/BREAKDOWN
  ...
  omni_file=file_search('D:\__Data\test\omni\*.cdf')
