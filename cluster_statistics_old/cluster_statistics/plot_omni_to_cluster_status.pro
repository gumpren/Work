...
pro plot_omni_to_cluster_status
  ...
  restore,filepath('time_need_omni_to_c3fgm_2001_2009_-0.5_Z_0.5.sav',root_dir='C:\__Data\Datasave\2001_2009_median_-0.5_Z_0.5')
  restore,filepath('C3_CIS_2001_2009_n_vbxyz_p_T_need_-0.5_Z_0.5.sav',root_dir='C:\__Data\Datasave\2001_2009_median_-0.5_Z_0.5')
  restore,filepath('eventimes_2001_2009_median_-0.5_Z_0.5_gap0.833.sav',root_dir='C:\__Data\Datasave\2001_2009_median_-0.5_Z_0.5')

  ;Bz_imf=Bz_imf [where(finite(Bz_imf))] 
...
;  
  ...
  TVLCT, r, g, b,/Get
  output_dir='E:\OneDrive\IDLworks\cluster_statistics\ps\2001_2009_median_-0.5_Z_0.5\'
  device,filename=output_dir+'omni_FGM_state_2001_2009_-0.5_Z_0.5_gap0.833.ps',xsize=5.5,ysize=6.5,xoffset=1,yoffset=2,/inches,/encapsulated
